...
module.exports = {
    ...
    upcomingAndRecent:function(){

        // 'upcoming' == today + 2 months; 'recent' == today - 2 months
        var upcoming    = moment().add(2, "M").format("YYYY-MM-DD");
        var recent      = moment().subtract(2, "M").format("YYYY-MM-DD");

        var options     = {
            'filterField':'store_date',
            'filterValue':recent + "|" + upcoming
        }
